...
import { Loader2, LayoutDashboard, BarChart3, Users, CalendarCheck, LogOut, Home, DollarSign, MessageSquare, Bell, Award } from 'lucide-react';
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-muted-foreground mb-6">
            You don't have manager permissions. Please contact an administrator to request access.
          </p>
    ...
    <div className="min-h-screen flex">
      ...
      <aside className="w-64 bg-navy text-primary-foreground flex flex-col shrink-0">
        <div className="p-6 border-b border-primary-foreground/10">
          ...
          <p className="text-xs text-primary-foreground/50 mt-1">Manager Panel</p>
        </div>
